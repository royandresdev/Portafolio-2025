      ...
      <div className="section-content">
        ...
        <div className="flex gap-12 items-center flex-1 pb-12">
          <div className="w-[650px]">
            <iframe width={650} height={365} src="https://www.youtube.com/embed/-SJfrF_vJ3A?si=TTO7f-YBR8tPcwUh" title="YouTube video player" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen></iframe>
          </div>
          <div>
