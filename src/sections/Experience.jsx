      ...
      <div className="section-content">
        ...
        <div className="flex flex-col lg:flex-row w-full gap-12 items-center flex-1 pb-12">
          <div className="w-full h-auto md:min-w-[650px] order-2 md:order-1">
            <iframe className="w-full aspect-video" src="https://www.youtube.com/embed/-SJfrF_vJ3A?si=TTO7f-YBR8tPcwUh" title="YouTube video player" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen></iframe>
          </div>
          <div className="order-1 md:order-2">
            ...
            <p className="hidden md:block">Me encargué de diseñar y programar el modelo de Usuario/Canal, permitiendo al usuario crear, leer, actualizar y eliminar su información personal y de su canal. También implementé la sección de edición total del Canal, donde el usuario puede personalizar el aspecto y el contenido de su canal según sus preferencias. Finalmente, colaboré en la sección de comentarios, desarrollando la lógica del backend para facilitar la interacción entre los usuarios.</p>
          </div>
        </div>
      </div>
    </section>
