...
const ProjectCard = ({ project }) => {
  ...
  return (
    <Frame styleContent="bg-primary-400 px-8 pt-4 pb-8 flex flex-col gap-3 flex-1 w-full h-full" styleFrame="h-full">
      <div>
      ...
      <div className="space-x-2 ">
        {
          technologies.map((tech, index) => <span key={index} className="bg-primary-base px-1 py-0.5 rounded text-primary-100">{tech}</span>)
        }
      </div>
